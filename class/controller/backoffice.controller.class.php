...
class backoffice
{
    public function defaultPage($args)
    {
		...
		$view->assign("nombrevisites", $users->requete("SELECT count(*) as nombre, activities.name FROM activities, feeling WHERE feeling.activities = activities.id group by activities.id order by nombre DESC"));			
